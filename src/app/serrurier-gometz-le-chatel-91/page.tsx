...
const cityData = {
  ...
  keywords: ['serrurier gometz-le-chatel-91', 'serrurier urgence gometz-le-chatel-91', 'ouverture porte gometz-le-chatel-91', 'serrurier 24h gometz-le-chatel-91', 'dépannage serrure gometz-le-chatel-91']
};

export default function Page() {
  return <CityPage 
    cityName="Gometz-le-Châtel"
    citySlug="gometz-le-chatel-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
