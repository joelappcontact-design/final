...
const cityData = {
  ...
  keywords: ['serrurier neuilly-sur-seine-92', 'serrurier urgence neuilly-sur-seine-92', 'ouverture porte neuilly-sur-seine-92', 'serrurier 24h neuilly-sur-seine-92', 'dépannage serrure neuilly-sur-seine-92']
};

export default function Page() {
  return <CityPage 
    cityName="Neuilly-sur-Seine"
    citySlug="neuilly-sur-seine-92"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
