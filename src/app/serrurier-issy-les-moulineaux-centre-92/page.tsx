...
const cityData = {
  ...
  keywords: ['serrurier issy-les-moulineaux-centre-92', 'serrurier urgence issy-les-moulineaux-centre-92', 'ouverture porte issy-les-moulineaux-centre-92', 'serrurier 24h issy-les-moulineaux-centre-92', 'dépannage serrure issy-les-moulineaux-centre-92']
};

export default function Page() {
  return <CityPage 
    cityName="Issy-les-Moulineaux-Centre"
    citySlug="issy-les-moulineaux-centre-92"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
