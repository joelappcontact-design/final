...
const cityData = {
  ...
  keywords: ['serrurier jouy-sur-morin-91', 'serrurier urgence jouy-sur-morin-91', 'ouverture porte jouy-sur-morin-91', 'serrurier 24h jouy-sur-morin-91', 'dépannage serrure jouy-sur-morin-91']
};

export default function Page() {
  return <CityPage 
    cityName="Jouy-sur-Morin"
    citySlug="jouy-sur-morin-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
