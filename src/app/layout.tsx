...
export const metadata: Metadata = {
  ...
  description: `Serrurier d'urgence ${config.primaryCity} - Intervention 24h/24, 7j/7. Intervention rapide, artisans vérifiés. Intervention en ${config.slaMinutes}.`,
  keywords: [
    'serrurier urgence',
    'serrurier paris',
    'ouverture porte',
  ...
  twitter: {
    ...
    title: `${config.siteName} - Serrurier d'urgence ${config.primaryCity} 24h/24`,
    description: `Serrurier d'urgence ${config.primaryCity} - Intervention 24h/24, 7j/7. Intervention rapide.`,
    images: ['/og-image.jpg'],
  },
  robots: {
    index: true,
