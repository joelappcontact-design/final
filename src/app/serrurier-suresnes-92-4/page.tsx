...
const cityData = {
  ...
  keywords: ['serrurier suresnes-92-4', 'serrurier urgence suresnes-92-4', 'ouverture porte suresnes-92-4', 'serrurier 24h suresnes-92-4', 'dépannage serrure suresnes-92-4']
};

export default function Page() {
  return <CityPage 
    cityName="Suresnes"
    citySlug="suresnes-92-4"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
