...
const cityData = {
  ...
  keywords: ['serrurier gometz-la-ville', 'serrurier urgence gometz-la-ville', 'ouverture porte gometz-la-ville', 'serrurier 24h gometz-la-ville', 'dépannage serrure gometz-la-ville']
};

export default function Page() {
  return <CityPage 
    cityName="Gometz-la-Ville"
    citySlug="gometz-la-ville"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
