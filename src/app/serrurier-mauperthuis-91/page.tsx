...
const cityData = {
  ...
  keywords: ['serrurier mauperthuis-91', 'serrurier urgence mauperthuis-91', 'ouverture porte mauperthuis-91', 'serrurier 24h mauperthuis-91', 'dépannage serrure mauperthuis-91']
};

export default function Page() {
  return <CityPage 
    cityName="Mauperthuis"
    citySlug="mauperthuis-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
