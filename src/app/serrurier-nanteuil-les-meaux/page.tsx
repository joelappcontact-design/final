...
const cityData = {
  ...
  keywords: ['serrurier nanteuil-les-meaux', 'serrurier urgence nanteuil-les-meaux', 'ouverture porte nanteuil-les-meaux', 'serrurier 24h nanteuil-les-meaux', 'dépannage serrure nanteuil-les-meaux']
};

export default function Page() {
  return <CityPage 
    cityName="Nanteuil-lès-Meaux"
    citySlug="nanteuil-les-meaux"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
