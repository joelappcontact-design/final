...
const cityData = {
  ...
  keywords: ['serrurier saint-germain-sur-morin-91', 'serrurier urgence saint-germain-sur-morin-91', 'ouverture porte saint-germain-sur-morin-91', 'serrurier 24h saint-germain-sur-morin-91', 'dépannage serrure saint-germain-sur-morin-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Germain-sur-Morin"
    citySlug="saint-germain-sur-morin-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
