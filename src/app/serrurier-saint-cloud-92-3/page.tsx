...
const cityData = {
  ...
  keywords: ['serrurier saint-cloud-92-3', 'serrurier urgence saint-cloud-92-3', 'ouverture porte saint-cloud-92-3', 'serrurier 24h saint-cloud-92-3', 'dépannage serrure saint-cloud-92-3']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Cloud"
    citySlug="saint-cloud-92-3"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
