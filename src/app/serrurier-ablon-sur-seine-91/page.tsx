...
const cityData = {
  ...
  keywords: ['serrurier ablon-sur-seine-91', 'serrurier urgence ablon-sur-seine-91', 'ouverture porte ablon-sur-seine-91', 'serrurier 24h ablon-sur-seine-91', 'dépannage serrure ablon-sur-seine-91']
};

export default function Page() {
  return <CityPage 
    cityName="Ablon-sur-Seine"
    citySlug="ablon-sur-seine-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
