...
const cityData = {
  ...
  keywords: ['serrurier montigny-sur-loing', 'serrurier urgence montigny-sur-loing', 'ouverture porte montigny-sur-loing', 'serrurier 24h montigny-sur-loing', 'dépannage serrure montigny-sur-loing']
};

export default function Page() {
  return <CityPage 
    cityName="Montigny-sur-Loing"
    citySlug="montigny-sur-loing"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
