...
const cityData = {
  ...
  keywords: ['serrurier sceaux-92-3', 'serrurier urgence sceaux-92-3', 'ouverture porte sceaux-92-3', 'serrurier 24h sceaux-92-3', 'dépannage serrure sceaux-92-3']
};

export default function Page() {
  return <CityPage 
    cityName="Sceaux"
    citySlug="sceaux-92-3"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
