...
const cityData = {
  ...
  keywords: ['serrurier vaucresson-92-3', 'serrurier urgence vaucresson-92-3', 'ouverture porte vaucresson-92-3', 'serrurier 24h vaucresson-92-3', 'dépannage serrure vaucresson-92-3']
};

export default function Page() {
  return <CityPage 
    cityName="Vaucresson"
    citySlug="vaucresson-92-3"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
