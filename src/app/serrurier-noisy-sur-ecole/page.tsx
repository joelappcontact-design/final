...
const cityData = {
  ...
  keywords: ['serrurier noisy-sur-ecole', 'serrurier urgence noisy-sur-ecole', 'ouverture porte noisy-sur-ecole', 'serrurier 24h noisy-sur-ecole', 'dépannage serrure noisy-sur-ecole']
};

export default function Page() {
  return <CityPage 
    cityName="Noisy-sur-École"
    citySlug="noisy-sur-ecole"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
