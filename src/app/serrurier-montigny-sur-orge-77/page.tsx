...
const cityData = {
  ...
  keywords: ['serrurier montigny-sur-orge-77', 'serrurier urgence montigny-sur-orge-77', 'ouverture porte montigny-sur-orge-77', 'serrurier 24h montigny-sur-orge-77', 'dépannage serrure montigny-sur-orge-77']
};

export default function Page() {
  return <CityPage 
    cityName="Montigny-sur-Orge"
    citySlug="montigny-sur-orge-77"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
