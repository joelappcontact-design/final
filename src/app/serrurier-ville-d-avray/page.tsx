...
const cityData = {
  ...
  keywords: ['serrurier ville-d-avray', 'serrurier urgence ville-d-avray', 'ouverture porte ville-d-avray', 'serrurier 24h ville-d-avray', 'dépannage serrure ville-d-avray']
};
