...
const cityData = {
  ...
  keywords: ['serrurier rueil-malmaison-92-2', 'serrurier urgence rueil-malmaison-92-2', 'ouverture porte rueil-malmaison-92-2', 'serrurier 24h rueil-malmaison-92-2', 'dépannage serrure rueil-malmaison-92-2']
};

export default function Page() {
  return <CityPage 
    cityName="Rueil-Malmaison"
    citySlug="rueil-malmaison-92-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
