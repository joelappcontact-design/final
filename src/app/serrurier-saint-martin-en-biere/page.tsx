...
const cityData = {
  ...
  keywords: ['serrurier saint-martin-en-biere', 'serrurier urgence saint-martin-en-biere', 'ouverture porte saint-martin-en-biere', 'serrurier 24h saint-martin-en-biere', 'dépannage serrure saint-martin-en-biere']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Martin-en-Bière"
    citySlug="saint-martin-en-biere"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
