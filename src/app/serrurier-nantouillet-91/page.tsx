...
const cityData = {
  ...
  keywords: ['serrurier nantouillet-91', 'serrurier urgence nantouillet-91', 'ouverture porte nantouillet-91', 'serrurier 24h nantouillet-91', 'dépannage serrure nantouillet-91']
};

export default function Page() {
  return <CityPage 
    cityName="Nantouillet"
    citySlug="nantouillet-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
