...
const cityData = {
  ...
  keywords: ['serrurier passy-sur-seine-91', 'serrurier urgence passy-sur-seine-91', 'ouverture porte passy-sur-seine-91', 'serrurier 24h passy-sur-seine-91', 'dépannage serrure passy-sur-seine-91']
};

export default function Page() {
  return <CityPage 
    cityName="Passy-sur-Seine"
    citySlug="passy-sur-seine-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
