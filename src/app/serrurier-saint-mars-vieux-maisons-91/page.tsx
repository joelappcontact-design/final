...
const cityData = {
  ...
  keywords: ['serrurier saint-mars-vieux-maisons-91', 'serrurier urgence saint-mars-vieux-maisons-91', 'ouverture porte saint-mars-vieux-maisons-91', 'serrurier 24h saint-mars-vieux-maisons-91', 'dépannage serrure saint-mars-vieux-maisons-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Mars-Vieux-Maisons"
    citySlug="saint-mars-vieux-maisons-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
