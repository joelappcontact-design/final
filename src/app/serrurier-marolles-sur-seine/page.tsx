...
const cityData = {
  ...
  keywords: ['serrurier marolles-sur-seine', 'serrurier urgence marolles-sur-seine', 'ouverture porte marolles-sur-seine', 'serrurier 24h marolles-sur-seine', 'dépannage serrure marolles-sur-seine']
};

export default function Page() {
  return <CityPage 
    cityName="Marolles-sur-Seine"
    citySlug="marolles-sur-seine"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
