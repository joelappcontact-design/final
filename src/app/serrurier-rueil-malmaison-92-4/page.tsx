...
const cityData = {
  ...
  keywords: ['serrurier rueil-malmaison-92-4', 'serrurier urgence rueil-malmaison-92-4', 'ouverture porte rueil-malmaison-92-4', 'serrurier 24h rueil-malmaison-92-4', 'dépannage serrure rueil-malmaison-92-4']
};

export default function Page() {
  return <CityPage 
    cityName="Rueil-Malmaison"
    citySlug="rueil-malmaison-92-4"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
