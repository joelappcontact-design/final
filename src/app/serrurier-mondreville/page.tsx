...
const cityData = {
  ...
  keywords: ['serrurier mondreville', 'serrurier urgence mondreville', 'ouverture porte mondreville', 'serrurier 24h mondreville', 'dépannage serrure mondreville']
};

export default function Page() {
  return <CityPage 
    cityName="Mondreville"
    citySlug="mondreville"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
