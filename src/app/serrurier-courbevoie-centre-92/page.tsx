...
const cityData = {
  ...
  keywords: ['serrurier courbevoie-centre-92', 'serrurier urgence courbevoie-centre-92', 'ouverture porte courbevoie-centre-92', 'serrurier 24h courbevoie-centre-92', 'dépannage serrure courbevoie-centre-92']
};

export default function Page() {
  return <CityPage 
    cityName="Courbevoie-Centre"
    citySlug="courbevoie-centre-92"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
