...
const cityData = {
  ...
  keywords: ['serrurier sceaux-92-2', 'serrurier urgence sceaux-92-2', 'ouverture porte sceaux-92-2', 'serrurier 24h sceaux-92-2', 'dépannage serrure sceaux-92-2']
};

export default function Page() {
  return <CityPage 
    cityName="Sceaux"
    citySlug="sceaux-92-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
