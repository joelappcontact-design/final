...
const cityData = {
  ...
  keywords: ['serrurier quincy-voisins-91', 'serrurier urgence quincy-voisins-91', 'ouverture porte quincy-voisins-91', 'serrurier 24h quincy-voisins-91', 'dépannage serrure quincy-voisins-91']
};

export default function Page() {
  return <CityPage 
    cityName="Quincy-Voisins"
    citySlug="quincy-voisins-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
