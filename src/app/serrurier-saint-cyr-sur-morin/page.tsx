...
const cityData = {
  ...
  keywords: ['serrurier saint-cyr-sur-morin', 'serrurier urgence saint-cyr-sur-morin', 'ouverture porte saint-cyr-sur-morin', 'serrurier 24h saint-cyr-sur-morin', 'dépannage serrure saint-cyr-sur-morin']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Cyr-sur-Morin"
    citySlug="saint-cyr-sur-morin"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
