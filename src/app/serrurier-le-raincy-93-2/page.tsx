...
const cityData = {
  ...
  keywords: ['serrurier le-raincy-93-2', 'serrurier urgence le-raincy-93-2', 'ouverture porte le-raincy-93-2', 'serrurier 24h le-raincy-93-2', 'dépannage serrure le-raincy-93-2']
};

export default function Page() {
  return <CityPage 
    cityName="Le Raincy"
    citySlug="le-raincy-93-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
