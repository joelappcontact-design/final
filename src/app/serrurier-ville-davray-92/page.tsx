...
const cityData = {
  ...
  keywords: ['serrurier ville-davray-92', 'serrurier urgence ville-davray-92', 'ouverture porte ville-davray-92', 'serrurier 24h ville-davray-92', 'dépannage serrure ville-davray-92']
};

export default function Page() {
  return <CityPage 
    cityName="Ville-d\'Avray"
    citySlug="ville-davray-92"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
