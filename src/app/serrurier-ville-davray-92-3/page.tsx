...
const cityData = {
  ...
  keywords: ['serrurier ville-davray-92-3', 'serrurier urgence ville-davray-92-3', 'ouverture porte ville-davray-92-3', 'serrurier 24h ville-davray-92-3', 'dépannage serrure ville-davray-92-3']
};

export default function Page() {
  return <CityPage 
    cityName="Ville-d\'Avray"
    citySlug="ville-davray-92-3"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
