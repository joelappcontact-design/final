...
const cityData = {
  ...
  keywords: ['serrurier saint-martin-en-biere-77', 'serrurier urgence saint-martin-en-biere-77', 'ouverture porte saint-martin-en-biere-77', 'serrurier 24h saint-martin-en-biere-77', 'dépannage serrure saint-martin-en-biere-77']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Martin-en-Bière"
    citySlug="saint-martin-en-biere-77"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
