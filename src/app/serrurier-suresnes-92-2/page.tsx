...
const cityData = {
  ...
  keywords: ['serrurier suresnes-92-2', 'serrurier urgence suresnes-92-2', 'ouverture porte suresnes-92-2', 'serrurier 24h suresnes-92-2', 'dépannage serrure suresnes-92-2']
};

export default function Page() {
  return <CityPage 
    cityName="Suresnes"
    citySlug="suresnes-92-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
