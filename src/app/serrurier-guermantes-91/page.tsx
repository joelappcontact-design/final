...
const cityData = {
  ...
  keywords: ['serrurier guermantes-91', 'serrurier urgence guermantes-91', 'ouverture porte guermantes-91', 'serrurier 24h guermantes-91', 'dépannage serrure guermantes-91']
};

export default function Page() {
  return <CityPage 
    cityName="Guermantes"
    citySlug="guermantes-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
