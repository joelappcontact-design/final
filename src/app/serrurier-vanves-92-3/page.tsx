...
const cityData = {
  ...
  keywords: ['serrurier vanves-92-3', 'serrurier urgence vanves-92-3', 'ouverture porte vanves-92-3', 'serrurier 24h vanves-92-3', 'dépannage serrure vanves-92-3']
};

export default function Page() {
  return <CityPage 
    cityName="Vanves"
    citySlug="vanves-92-3"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
