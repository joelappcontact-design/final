...
const cityData = {
  ...
  keywords: ['serrurier noisy-rudignon', 'serrurier urgence noisy-rudignon', 'ouverture porte noisy-rudignon', 'serrurier 24h noisy-rudignon', 'dépannage serrure noisy-rudignon']
};

export default function Page() {
  return <CityPage 
    cityName="Noisy-Rudignon"
    citySlug="noisy-rudignon"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
