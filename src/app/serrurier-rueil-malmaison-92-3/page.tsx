...
const cityData = {
  ...
  keywords: ['serrurier rueil-malmaison-92-3', 'serrurier urgence rueil-malmaison-92-3', 'ouverture porte rueil-malmaison-92-3', 'serrurier 24h rueil-malmaison-92-3', 'dépannage serrure rueil-malmaison-92-3']
};

export default function Page() {
  return <CityPage 
    cityName="Rueil-Malmaison"
    citySlug="rueil-malmaison-92-3"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
