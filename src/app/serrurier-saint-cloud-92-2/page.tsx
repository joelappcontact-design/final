...
const cityData = {
  ...
  keywords: ['serrurier saint-cloud-92-2', 'serrurier urgence saint-cloud-92-2', 'ouverture porte saint-cloud-92-2', 'serrurier 24h saint-cloud-92-2', 'dépannage serrure saint-cloud-92-2']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Cloud"
    citySlug="saint-cloud-92-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
