...
const cityData = {
  ...
  keywords: ['serrurier rueil-malmaison-92-5', 'serrurier urgence rueil-malmaison-92-5', 'ouverture porte rueil-malmaison-92-5', 'serrurier 24h rueil-malmaison-92-5', 'dépannage serrure rueil-malmaison-92-5']
};

export default function Page() {
  return <CityPage 
    cityName="Rueil-Malmaison"
    citySlug="rueil-malmaison-92-5"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
