...
const cityData = {
  ...
  keywords: ['serrurier saint-cloud-92-4', 'serrurier urgence saint-cloud-92-4', 'ouverture porte saint-cloud-92-4', 'serrurier 24h saint-cloud-92-4', 'dépannage serrure saint-cloud-92-4']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Cloud"
    citySlug="saint-cloud-92-4"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
