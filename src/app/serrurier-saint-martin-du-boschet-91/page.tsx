...
const cityData = {
  ...
  keywords: ['serrurier saint-martin-du-boschet-91', 'serrurier urgence saint-martin-du-boschet-91', 'ouverture porte saint-martin-du-boschet-91', 'serrurier 24h saint-martin-du-boschet-91', 'dépannage serrure saint-martin-du-boschet-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Martin-du-Boschet"
    citySlug="saint-martin-du-boschet-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
