...
const cityData = {
  ...
  keywords: ['serrurier saint-ouen-sur-morin-91', 'serrurier urgence saint-ouen-sur-morin-91', 'ouverture porte saint-ouen-sur-morin-91', 'serrurier 24h saint-ouen-sur-morin-91', 'dépannage serrure saint-ouen-sur-morin-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Ouen-sur-Morin"
    citySlug="saint-ouen-sur-morin-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
