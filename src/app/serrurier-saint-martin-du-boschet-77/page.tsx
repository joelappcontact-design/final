...
const cityData = {
  ...
  keywords: ['serrurier saint-martin-du-boschet-77', 'serrurier urgence saint-martin-du-boschet-77', 'ouverture porte saint-martin-du-boschet-77', 'serrurier 24h saint-martin-du-boschet-77', 'dépannage serrure saint-martin-du-boschet-77']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Martin-du-Boschet"
    citySlug="saint-martin-du-boschet-77"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
