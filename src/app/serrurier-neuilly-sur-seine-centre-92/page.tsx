...
const cityData = {
  ...
  keywords: ['serrurier neuilly-sur-seine-centre-92', 'serrurier urgence neuilly-sur-seine-centre-92', 'ouverture porte neuilly-sur-seine-centre-92', 'serrurier 24h neuilly-sur-seine-centre-92', 'dépannage serrure neuilly-sur-seine-centre-92']
};

export default function Page() {
  return <CityPage 
    cityName="Neuilly-sur-Seine-Centre"
    citySlug="neuilly-sur-seine-centre-92"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
