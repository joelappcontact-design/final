...
const cityData = {
  ...
  keywords: ['serrurier saint-just-en-brie-91', 'serrurier urgence saint-just-en-brie-91', 'ouverture porte saint-just-en-brie-91', 'serrurier 24h saint-just-en-brie-91', 'dépannage serrure saint-just-en-brie-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Just-en-Brie"
    citySlug="saint-just-en-brie-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
