...
const cityData = {
  ...
  keywords: ['serrurier saint-leger-91', 'serrurier urgence saint-leger-91', 'ouverture porte saint-leger-91', 'serrurier 24h saint-leger-91', 'dépannage serrure saint-leger-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Léger"
    citySlug="saint-leger-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
