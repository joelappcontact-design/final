...
const cityData = {
  ...
  keywords: ['serrurier pontault-combault-77', 'serrurier urgence pontault-combault-77', 'ouverture porte pontault-combault-77', 'serrurier 24h pontault-combault-77', 'dépannage serrure pontault-combault-77']
};

export default function Page() {
  return <CityPage 
    cityName="Pontault-Combault"
    citySlug="pontault-combault-77"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
