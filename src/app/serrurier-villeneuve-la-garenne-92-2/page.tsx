...
const cityData = {
  ...
  keywords: ['serrurier villeneuve-la-garenne-92-2', 'serrurier urgence villeneuve-la-garenne-92-2', 'ouverture porte villeneuve-la-garenne-92-2', 'serrurier 24h villeneuve-la-garenne-92-2', 'dépannage serrure villeneuve-la-garenne-92-2']
};

export default function Page() {
  return <CityPage 
    cityName="Villeneuve-la-Garenne"
    citySlug="villeneuve-la-garenne-92-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
