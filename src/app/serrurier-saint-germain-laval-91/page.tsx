...
const cityData = {
  ...
  keywords: ['serrurier saint-germain-laval-91', 'serrurier urgence saint-germain-laval-91', 'ouverture porte saint-germain-laval-91', 'serrurier 24h saint-germain-laval-91', 'dépannage serrure saint-germain-laval-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Germain-Laval"
    citySlug="saint-germain-laval-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
