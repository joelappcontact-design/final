...
const cityData = {
  ...
  keywords: ['serrurier savigny-le-temple', 'serrurier urgence savigny-le-temple', 'ouverture porte savigny-le-temple', 'serrurier 24h savigny-le-temple', 'dépannage serrure savigny-le-temple']
};

export default function Page() {
  return <CityPage 
    cityName="Savigny-le-Temple"
    citySlug="savigny-le-temple"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
