...
const cityData = {
  ...
  keywords: ['serrurier couilly-pont-aux-dames', 'serrurier urgence couilly-pont-aux-dames', 'ouverture porte couilly-pont-aux-dames', 'serrurier 24h couilly-pont-aux-dames', 'dépannage serrure couilly-pont-aux-dames']
};

export default function Page() {
  return <CityPage 
    cityName="Couilly-Pont-aux-Dames"
    citySlug="couilly-pont-aux-dames"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
