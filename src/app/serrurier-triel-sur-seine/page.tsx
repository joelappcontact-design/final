...
const cityData = {
  ...
  keywords: ['serrurier triel-sur-seine', 'serrurier urgence triel-sur-seine', 'ouverture porte triel-sur-seine', 'serrurier 24h triel-sur-seine', 'dépannage serrure triel-sur-seine']
};

export default function Page() {
  return <CityPage 
    cityName="Triel-sur-Seine"
    citySlug="triel-sur-seine"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
