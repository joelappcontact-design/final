...
const cityData = {
  ...
  keywords: ['serrurier saint-denis-93', 'serrurier urgence saint-denis-93', 'ouverture porte saint-denis-93', 'serrurier 24h saint-denis-93', 'dépannage serrure saint-denis-93']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Denis"
    citySlug="saint-denis-93"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
