...
const cityData = {
  ...
  keywords: ['serrurier saint-germain-sur-ecole-91', 'serrurier urgence saint-germain-sur-ecole-91', 'ouverture porte saint-germain-sur-ecole-91', 'serrurier 24h saint-germain-sur-ecole-91', 'dépannage serrure saint-germain-sur-ecole-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Germain-sur-École"
    citySlug="saint-germain-sur-ecole-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
