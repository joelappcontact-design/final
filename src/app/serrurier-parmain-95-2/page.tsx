...
const cityData = {
  ...
  keywords: ['serrurier parmain-95-2', 'serrurier urgence parmain-95-2', 'ouverture porte parmain-95-2', 'serrurier 24h parmain-95-2', 'dépannage serrure parmain-95-2']
};

export default function Page() {
  return <CityPage 
    cityName="Parmain"
    citySlug="parmain-95-2"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
