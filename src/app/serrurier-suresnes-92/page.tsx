...
const cityData = {
  ...
  keywords: ['serrurier suresnes-92', 'serrurier urgence suresnes-92', 'ouverture porte suresnes-92', 'serrurier 24h suresnes-92', 'dépannage serrure suresnes-92']
};

export default function Page() {
  return <CityPage 
    cityName="Suresnes"
    citySlug="suresnes-92"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
