...
const cityData = {
  ...
  keywords: ['serrurier saint-fargeau-ponthierry-91', 'serrurier urgence saint-fargeau-ponthierry-91', 'ouverture porte saint-fargeau-ponthierry-91', 'serrurier 24h saint-fargeau-ponthierry-91', 'dépannage serrure saint-fargeau-ponthierry-91']
};

export default function Page() {
  return <CityPage 
    cityName="Saint-Fargeau-Ponthierry"
    citySlug="saint-fargeau-ponthierry-91"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
