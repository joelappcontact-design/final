...
const cityData = {
  ...
  keywords: ['serrurier levallois-perret-centre', 'serrurier urgence levallois-perret-centre', 'ouverture porte levallois-perret-centre', 'serrurier 24h levallois-perret-centre', 'dépannage serrure levallois-perret-centre']
};

export default function Page() {
  return <CityPage 
    cityName="Levallois-Perret-Centre"
    citySlug="levallois-perret-centre"
    zones={['Centre-ville', 'Quartier de la République', 'Quartier de la Gare', 'Quartier du Parc']}
