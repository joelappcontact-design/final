...
export const config = {
  ...
  pricing: {
    ...
    secureDoor: parseInt(process.env.NEXT_PUBLIC_PRICE_SECURE_DOOR || "29900"),
  },
  ...
  partners: [
    ...
    { name: "DOM", url: "https://www.dom.fr", logo: "/assets/partners/dom.svg" },
    { name: "Fichet", url: "https://www.fichet.com", logo: "/assets/partners/fichet.svg" },
    { name: "Héraclès", url: "https://www.heracles.fr", logo: "/assets/partners/heracles.svg" },
...
export const formatPrice = (priceInCents: number): string => {
  return `${(priceInCents / 100).toFixed(0)}€ TTC`;
};
